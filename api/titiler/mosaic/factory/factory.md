...
class MosaicTilerFactory(
    reader: Type[cogeo_mosaic.backends.base.BaseBackend] = <function MosaicBackend at 0x7f3c4ff1bc10>,
    reader_options: Dict = <factory>,
    router: fastapi.routing.APIRouter = <factory>,
    path_dependency: Callable[..., str] = <function DatasetPathParams at 0x7f3c4edda940>,
    ...
    colormap_dependency: Callable[..., Union[Dict, NoneType]] = <function ColorMapParams at 0x7f3c4edda8b0>,
    tms_dependency: Callable[..., morecantile.models.TileMatrixSet] = <function WebMercatorTMSParams at 0x7f3c4ef685e0>,
    additional_dependency: Callable[..., Dict] = <function BaseTilerFactory.<lambda> at 0x7f3c4ed0aa60>,
    router_prefix: str = '',
